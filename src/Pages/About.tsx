    ...
    <div className="bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="relative z-20 flex flex-col md:flex-row items-center justify-center md:justify-between min-h-[calc(100vh-96px)] px-6 md:px-20 py-14 md:py-0 gap-12"
        >
          {/* LEFT CONTENT */}
          <div className="max-w-2xl text-center md:text-left">
            ...
            <motion.p
              variants={item}
              className="mt-6 text-sm sm:text-base text-white/80 leading-relaxed"
            >
              A passionate cinematographer crafting visual stories that blend
              emotion, light, and movement into unforgettable experiences.
            </motion.p>
          ...
          >
            <img
              src="./images/image (3).png"
              alt="Vikrant"
              className="w-[220px] sm:w-[280px] md:w-[350px] h-[280px] sm:h-[340px] md:h-[420px] object-cover rounded-2xl shadow-2xl"
            />
      ...
      {/* EXPERIENCE / STATS */}
      <section className="bg-white text-black px-6 md:px-20 py-16 md:py-20">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
      ...
      {/* CTA */}
      <section className="px-6 md:px-20 pb-16 md:pb-20 text-center">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="border border-white px-8 py-3 uppercase tracking-wider hover:bg-white hover:text-black transition text-sm sm:text-base w-full sm:w-auto"
          >
            Contact Now
          </motion.button>
        </motion.div>
