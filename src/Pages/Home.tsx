...
function Home() {
  ...
  // Images (place inside /public/images/)
  const originalImages = [
    "/images/IMG_7038.PNG",
    "/images/IMG_0685.JPG.jpeg",
    "/images/IMG_5607.JPG.jpeg",
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="relative z-20 flex h-full items-center justify-center md:justify-start px-4 sm:px-6 md:px-20 text-center md:text-left"
        >
          <div className="max-w-3xl">
            <motion.h1
              variants={itemTopToBottom}
            ...
            <motion.p
              variants={itemTopToBottom}
              className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base text-white/80 leading-relaxed"
            >
              Have a deep dive into Vikrant’s portfolio of cinematography work.
            </motion.p>
            ...
            >
              <button
                className="border border-white px-6 py-3 text-xs sm:text-sm uppercase tracking-wider hover:bg-white hover:text-black transition"
                onClick={() => navigate("/showreel")}
              >
                Explore Portfolio
              </button>
      ...
      {/* SLIDER SECTION */}
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-20 bg-black">
        ...
        <div className="overflow-hidden">
          <motion.div
            ...
            dragElastic={0.05}
            dragMomentum={false}
            className="flex gap-4 sm:gap-6 cursor-grab active:cursor-grabbing px-1"
          >
            {duplicatedImages.map((img, i) => (
              <motion.div
                key={i}
